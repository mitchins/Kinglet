...
async def demonstrate_cost_patterns():
    ...
    user = await User.objects.create(
        db, email="test@example.com", username="test", name="Test User"
    )
    ...
    print("   💰 Cost: 1 row read vs full table scan\\n")
    ...
    await User.objects.create(
        db, email="user2@example.com", username="user2", name="User Two", age=25
    )
    await User.objects.create(
        db, email="user3@example.com", username="user3", name="User Three", age=30
    )
    ...
    print("   💰 Cost: 1-2 columns per row vs 5 columns per row (60-80% savings)\\n")
    ...
    print("   💰 Cost: 1-2 operations vs 2-3 operations (33-50% savings)\\n")
    ...
    print("   💰 Cost: Minimal columns + early termination\\n")
    ...
    print("   💰 Cost: 1 batch vs 5 individual INSERTs\\n")
