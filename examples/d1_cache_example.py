...
from kinglet import D1CacheService, Kinglet, cache_aside_d1, ensure_cache_table
...
async def get_cache_stats(request):
    ...
    cache_service = D1CacheService(
        request.env.DB, track_hits=True
    )  # Enable for stats query
