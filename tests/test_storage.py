...
from kinglet.storage import (
    d1_unwrap, d1_unwrap_results, r2_get_metadata,
    _is_js_undefined, _traverse_path_part, 
    _access_attribute, _access_dict_key, _access_bracket_notation
)
...
class TestR2MetadataIntegration:
    ...
    def test_r2_get_metadata_nested_path(self):
        ...
        result = r2_get_metadata(obj, "httpMetadata.contentType", "application/octet-stream")
